...
public class PlacesEditor extends JPanel implements EditorRecord {
    ...
    private void initComponents() {
        ...
        add(m_jName);
        m_jName.setBounds(110, 20, 180, 26);

        jLabel3.setText(AppLocal.getIntString("label.placeposition")); // NOI18N
        add(jLabel3);
        jLabel3.setBounds(20, 80, 90, 16);
        add(m_jX);
        m_jX.setBounds(110, 80, 50, 26);
        add(m_jY);
        m_jY.setBounds(170, 80, 50, 26);

        jLabel1.setText(AppLocal.getIntString("label.placefloor")); // NOI18N
        add(jLabel1);
        jLabel1.setBounds(20, 50, 90, 16);

        m_jFloor.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        add(m_jFloor);
