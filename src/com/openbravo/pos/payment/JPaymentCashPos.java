...
import com.openbravo.pos.util.VariableG;//@Ade
...
public class JPaymentCashPos extends javax.swing.JPanel implements JPaymentInterface {
    ...
    private void printState() {
        System.out.println("Panggil "+m_dPaid);//@ade
        //if (m_given < 2) {
            if (VariableG.ticketInfo != null) {
                if (VariableG.ticketInfo.getProperty("cash") != null && !VariableG.ticketInfo.getProperty("cash").equalsIgnoreCase("")) {
                    
                    m_dPaid = Double.parseDouble(VariableG.ticketInfo.getProperty("cash"));
                }else{
                    //m_dPaid=m_dTotal;
            ...
            System.out.println("Pay given " + m_dPaid);//@ade
            //m_given++;
        /*} else {
            Double value = m_jTendered.getDoubleValue();
            if (value == null || value == 0.0) {
        ...
        /* 
        if (m_given > 0) {
        m_jMoneyEuros.setText(Formats.CURRENCY.formatValue(new Double(m_given)));            
        m_jChangeEuros.setText((m_given - m_dTotal)>0?Formats.CURRENCY.formatValue(new Double(m_given - m_dTotal)):null);
        } else {
        m_given=0;
        }
         */
