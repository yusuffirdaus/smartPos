...
public abstract class JPaymentSelect extends javax.swing.JDialog 
    ...
    public class JPaymentPaper1Creator implements JPaymentCreator {
        public JPaymentInterface createJPayment() {
            return new JPaymentPaper1(JPaymentSelect.this, "paperin-kantor");
        }
        public String getKey() { return "payment.paper1"; }
        public String getLabelKey() { return "tab.paper1"; }
        public String getIconKey() { return "/com/openbravo/images/knotes.png"; }
    }
    
    public class JPaymentVoucherCreator implements JPaymentCreator {
        public JPaymentInterface createJPayment() {
            return new JPaymentVoucher(JPaymentSelect.this, "voucher");
        }
