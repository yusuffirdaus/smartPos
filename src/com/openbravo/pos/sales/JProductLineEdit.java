...
public class JProductLineEdit extends javax.swing.JDialog {
    ...
    private TicketLineInfo init(AppView app, TicketLineInfo oLine,ProductInfoExt proInfoExt, DataLogicSales dlSales,DataLogicSystem dlSystem) throws BasicException {
        ...
        m_jTunit.setText( oLine.getProperty("unidadDefaultTexto"));
...
//        m_jPriceTax.addEditorKeys(m_jKeys);
    ...
    private void changePrice() {
        ...
        if(acction == 0){
            ...
            UnitInfo infoU = null;
            try {
                infoU = dlSales.getUnitInfo(unityId);
            ...
            m_oLine.setProperty("unidadDefaultTexto", infoU.getName());
            m_oLine.setProperty("unidadDefault", unityId);
            m_jPriceTax.setDoubleValue(m_oLine.getPriceTax());
            m_jTunit.setText(m_oLine.getProperty("unidadDefaultTexto"));
        }
        printTotals();
    }
    ...
    private void initComponents() {
        ...
        m_jTunit = new javax.swing.JLabel();
        ...
        m_jUnits.setBounds(100, 50, 140, 25);
        ...
        jPanel2.add(jLabel8);
        jLabel8.setBounds(10, 200, 90, 14);

        m_jNotes.setText("Ninguna");
        jPanel2.add(m_jNotes);
        m_jNotes.setBounds(100, 230, 210, 20);
        ...
        jButton1.setBounds(330, 80, 40, 30);

        m_jTunit.setText("Default");
        jPanel2.add(m_jTunit);
        m_jTunit.setBounds(250, 50, 80, 20);
        ...
        setBounds((screenSize.width-580)/2, (screenSize.height-348)/2, 580, 348);
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    private javax.swing.JLabel m_jTunit;
