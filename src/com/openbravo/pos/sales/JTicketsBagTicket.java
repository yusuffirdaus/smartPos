...
//import com.openbravo.pos.sales.restaurant.Place;//@win
    ...
    private void printTicket() {
        ...
        if (m_ticket == null) {
            ...
            try {
                ...
                script.put("infoEnd1", m_dlSystem.getResourceAsText("info.end1"));//@win
                script.put("infoEnd2", m_dlSystem.getResourceAsText("info.end2"));
                script.put("place", VariableG.place);//@win
    ...
    private void m_jPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jPrintActionPerformed
        ...
        if (m_ticket != null) {
            try {
                ...
                script.put("infoCity", m_dlSystem.getResourceAsText("info.city"));
                script.put("infoEnd1", m_dlSystem.getResourceAsText("info.end1"));//@win
                script.put("infoEnd2", m_dlSystem.getResourceAsText("info.end2"));//@win
                script.put("place", VariableG.place);
...
/**
     * Send a ticket cancellation (VOID) to the ERP   SmartPOS
     */
