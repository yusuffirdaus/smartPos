...
public class JPanelCloseMoney extends JPanel implements JPanelView, BeanFactoryApp {
    ...
    private void printPayments(String report) {
        ...
        if (sresource == null) {
            ...
            try {
                ...
                //m_TTP2.printTicket(script.eval(sresource2).toString());
    ...
    private void printEmail(String report2) {
        
        String sresource2 = m_dlSystem.getResourceAsXML(report2);
        if (sresource2 == null) {
            MessageInf msg = new MessageInf(MessageInf.SGN_WARNING, AppLocal.getIntString("message.cannotsendemail"));
            msg.show(this);
        } else {
            try {
                ScriptEngine script = ScriptFactory.getScriptEngine(ScriptFactory.VELOCITY);
                ...
                MessageInf msg = new MessageInf(MessageInf.SGN_WARNING, AppLocal.getIntString("message.cannotsendemail"), e);
                msg.show(this);
            } catch (TicketPrinterException e) {
                Logger.getLogger(JPanelCloseMoney.class.getName()).log(Level.SEVERE, null, e);
                MessageInf msg = new MessageInf(MessageInf.SGN_WARNING, AppLocal.getIntString("message.cannotsendemail"), e);
    ...
    private void m_jCloseCashActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jCloseCashActionPerformed
        ...
        JPanelCloseMoney close = new JPanelCloseMoney();
        ...
        if (res == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                printEmail("email.closeCash");
                sendEmail();
                //@win
//                try {
//                    Thread.sleep(20000);
//                    System.out.println("###############generateXMLErp.... ");
//                    Runtime.getRuntime().exec("java -jar GenerateXMLErp.jar");
