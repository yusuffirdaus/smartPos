...
public class JProductFinder extends javax.swing.JDialog {
    ...
    private ProductInfoExt init(DataLogicSales dlSales, int productsType) {
        ...
        //   SmartPOS  - exeture a normal product list when starts
             try {
    ...
    private void initComponents() {
        ...
        jButton3.setMnemonic(KeyEvent.VK_ENTER);
        ...
        jListProducts.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jPanel6.setPreferredSize(new java.awt.Dimension(560, 28));

        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("pos_messages"); // NOI18N
        jLabel1.setText(bundle.getString("label.stockproduct")); // NOI18N
        ...
        setSize(new java.awt.Dimension(880, 565));
