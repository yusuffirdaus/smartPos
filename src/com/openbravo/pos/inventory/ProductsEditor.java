...
//        txtAttributes.setEnabled(true);
    ...
    public void writeValueDelete(Object value) {
        ...
        try {
            m_jCatalogLocation.setText(dlSales.getLocationProduct( (String)m_id));
...
//        txtAttributes.setEnabled(true);
        ...
        String stock = "0";
        try {
            stock = Double.toString(dlSales.findProductStock((String)m_id, null));
        } catch (BasicException ex) {
            Logger.getLogger(ProductsEditor.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        jLabel19.setText(dlSystem.getResourceAsText("label.priceLimtTax"));
    ...
    private void loadAdditionalPricesForProductsInfo(String unitId) {
        ...
        try{
            ...
            /** creates units when there is no default o uni defines por this products  **/
    ...
    private void initComponents() {
        ...
        m_jCatalogLocation = new javax.swing.JTextField();
        ...
        jPanel1.add(jLabel5);
        jLabel5.setBounds(10, 100, 150, 16);

        m_jCategory.setEnabled(false);
        jPanel1.add(m_jCategory);
        m_jCategory.setBounds(160, 100, 170, 20);

        jLabel7.setText(AppLocal.getIntString("label.taxcategory")); // NOI18N
        jPanel1.add(jLabel7);
        jLabel7.setBounds(10, 60, 150, 16);

        m_jTax.setEnabled(false);
        jPanel1.add(m_jTax);
        m_jTax.setBounds(160, 60, 170, 20);

        jLabel13.setText(AppLocal.getIntString("label.attributes")); // NOI18N
        jPanel1.add(jLabel13);
        jLabel13.setBounds(10, 140, 150, 16);

        m_jAtt.setEnabled(false);
        jPanel1.add(m_jAtt);
        m_jAtt.setBounds(160, 140, 170, 20);
        ...
        jLabel19.setText(AppLocal.getIntString("find.titleLocation")); // NOI18N

        m_jCatalogLocation.setEditable(false);
        m_jCatalogLocation.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        m_jCatalogLocation.setEnabled(false);
                ...
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel2Layout.createSequentialGroup()
                        ...
                        .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(jLabel19, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 60, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                            .add(m_jCatalogOrder, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
                            .add(m_jstockvolume, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
                            .add(m_jUnit, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
                            .add(m_jCatalogLocation))
                        .add(105, 105, 105))
                    .add(jPanel2Layout.createSequentialGroup()
                ...
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(jPanel2Layout.createSequentialGroup()
                        ...
                        .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(jPanel2Layout.createSequentialGroup()
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                                .add(m_jCatalogLocation, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                        .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jPanel2Layout.createSequentialGroup()
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        ...
        add(jTabbedPane1);
        jTabbedPane1.setBounds(10, 80, 560, 290);

        jLabel3.setText(AppLocal.getIntString("label.prodpricebuy")); // NOI18N
        add(jLabel3);
        jLabel3.setBounds(20, 380, 150, 16);

        m_jPriceBuy.setEditable(false);
        m_jPriceBuy.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        add(m_jPriceBuy);
        m_jPriceBuy.setBounds(170, 380, 80, 22);

        m_jCodetype.setEnabled(false);
        add(m_jCodetype);
        m_jCodetype.setBounds(270, 380, 80, 20);
...
// TODO add your handling code here:
    ...
    private javax.swing.JTextField m_jCatalogLocation;
