        ...
        return new SerializerRead() 
          {
            ...
            {
            return new AdditionalPricesForProductsInfo(dr.getString(1), dr.getString(2), dr.getString(3), 
                    dr.getDouble(4), dr.getDouble(5),dr.getString(6),dr.getDouble(7),
                    dr.getDouble(8),dr.getDouble(9));
            }
          };
    }
