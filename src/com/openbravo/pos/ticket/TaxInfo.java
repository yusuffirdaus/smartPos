    ...
    public String printRate(){
     ...
     public static SerializerRead getSerializerRead() {
        return new SerializerRead() { public Object readValues(DataRead dr) throws BasicException {
            return new TaxInfo(dr.getString(1), dr.getString(2),dr.getString(3),(java.util.Date) dr.getObject(4),dr.getString(5), dr.getString(6) , dr.getDouble(7), dr.getBoolean(8),dr.getInt(9));
        }};
    }
}
