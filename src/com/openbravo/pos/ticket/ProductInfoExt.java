...
/**
 * Returns Info about products 
 * @original author adrianromero
...
public class ProductInfoExt {
    ...
    public static SerializerRead getSerializerRead() {
        return new SerializerRead() { public Object readValues(DataRead dr) throws BasicException {
            ...
            //product.m_bVisible = dr.getBoolean(14).booleanValue(); //@win
            /**
             * modificacion para agregar unidades por defecto - 
             * modification to add default units
             */
            try{
                product.m_dPriceSellSpecial = dr.getDouble(14).doubleValue();//14
                product.m_dPriceSellMin = dr.getDouble(15).doubleValue();//15
                product.m_dUnit = dr.getString(16);//16
            }catch(Exception e){
    ...
    public final String toString() {
        ...
        return m_sRef + " - " + m_sName + "prop:"+prop;
    }
