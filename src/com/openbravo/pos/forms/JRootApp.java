...
public class JRootApp extends JPanel implements AppView {
    ...
    public static   String jmsInPort;
    public static   String jmsOutPort;
    public static   String currentCustomer = null;   // last customer (taxid) modified or inserted, ready for sales
    ...
    public static AppProperties getM_props() {
        return m_props;
    }
    ...
    public boolean initApp(AppProperties props) {
        ...
        jmsInPort = m_dlSystem.getResourceAsText("jms.inport"); 
        jmsOutPort = m_dlSystem.getResourceAsText("jms.outport"); 
        ...
        Logger.getLogger(JRootApp.class.getName()). log(Level.SEVERE,"URL del server JMS:"+jmsUrl);
        
        Logger.getLogger(JRootApp.class.getName()). log(Level.SEVERE,"URL de la cola de salida JMS:"+jmsOutgoingQueue );
        ...
        showLogin();
        //SmartPOS
        //startActiveMQ();  embebbed queue is removed from the start process
        
        //Conexion con la cola // start the ERP listener (connected to the external MQ broker)
    ...
    public JPrincipalApp getM_principalapp() {
    ...
    /**
     * Crea la conexion a la cola para recibir mensajes del  ERP
     */
    private void startTopicConnection(){
        try {
            ...
            Thread consumerThread = new Thread(eRPListener);
           // try {
...
/**********************FIN de la presonalizacion*****************************************/        
    ...
    private void initComponents() {
        ...
        m_jLblTitle.setOpaque(true);
        m_jLblTitle.setPreferredSize(new java.awt.Dimension(35, 16));
        m_jPanelTitle.add(m_jLblTitle, java.awt.BorderLayout.CENTER);

        jLabel2.setPreferredSize(new java.awt.Dimension(35, 34));
        ...
        jLabel1.setText("<html><center><br>" +
            "100% Enterprise Open Source with GPL V2 License<br>" +
            "Integrated by <A href=\"http://www.smartjsp.com\">http://www.smartjsp.com</A> (c) 2013 <br>" +
            "Powered by OpenBravoPOS, SmartERP & RabbitMQ <br>" +
            "</center>");
    ...
    private void m_jCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jCloseActionPerformed
       if ( JOptionPane.showConfirmDialog(this ,AppLocal.getIntString("Menu.Exit")+" ?", "SmartPOS",
                        JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION)
            {
              tryToClose();
            }      
