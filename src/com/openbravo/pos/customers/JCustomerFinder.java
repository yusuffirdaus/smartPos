    ...
    public void executeSearch() {
        try {
            ...
            if (jListCustomers.getModel().getSize() > 0) {
                ...
                if (JOptionPane.showConfirmDialog(this, AppLocal.getIntString("message.wishcreatecustomer"),
